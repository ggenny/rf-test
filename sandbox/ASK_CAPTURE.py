...
class ASK_CAPTURE(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ASK_CAPTURE")
        ...
        self.samp_per_sym = samp_per_sym = 320
        self.gain = gain = 20
        self.freq = freq = 433.90e6
        self.cut = cut = 32000
        ...
        self._samp_per_sym_range = qtgui.Range(1, 10000, 1, 320, 200)
        self._samp_per_sym_win = qtgui.RangeWidget(self._samp_per_sym_range, self.set_samp_per_sym, "'samp_per_sym'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._samp_per_sym_win)
        self._gain_range = qtgui.Range(0, 100, 1, 20, 200)
        self._gain_win = qtgui.RangeWidget(self._gain_range, self.set_gain, "'gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._gain_win)
        self._freq_range = qtgui.Range(10e6, 1000e6, 0.1e6, 433.90e6, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "'freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_win)
        self._cut_range = qtgui.Range(1000, 100000, 1000, 32000, 200)
        self._cut_win = qtgui.RangeWidget(self._cut_range, self.set_cut, "'cut'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.blocks_float_to_uchar_1, 0), (self.qtgui_time_raster_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(5, self.samp_rate, self.cut, 100000, window.WIN_HAMMING, 6.76))
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.analog_agc_xx_0.set_max_gain(self.gain)
...
def main(top_block_cls=ASK_CAPTURE, options=None):
