...
# Stima dell'offset DC
dc_offset = np.mean(I)  # Calcola la media del segnale I, che rappresenta la componente DC

print("Componente DC:", dc_offset)

# Sottrai la componente DC dal segnale originale
I = I - dc_offset

# Normalizzazione e conversione del segnale in formato uint8
