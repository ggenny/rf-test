...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                ...
                taps=[],
                fractional_bw=0)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(256)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/ggenny/Develop/rf-test/sandbox/BBD_0010_full.raw', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/ggenny/Develop/rf-test/sandbox/BBD_0010_full.raw.C8', False)
